...
def load_shake(cid):
    ...
    trainset = ShakespeareDataset(os.path.join(dirname, ("shakespeareDataset\\" + str(cid) + "\\train.pickle")))

    # Test set
    testset = ShakespeareDataset(os.path.join(dirname, ("shakespeareDataset\\" + str(cid) + "\\test.pickle")))
